...
file_path = '/Users/zselykenemeth/Desktop/dataset_it_hpv.csv'
...
def preprocess_tweet(text):
    ...
    text = re.sub(r'[^a-zA-Zàèéìòùç\s]', '', text)
...
output_path = '/Users/zselykenemeth/Desktop/processed_tweets_it_hpv.csv'
